...
class OrdersLandWorkTable extends SupabaseTable<OrdersLandWorkRow> {
  @override
  String get tableName => 'ordersLandWork';

  @override
  OrdersLandWorkRow createRow(Map<String, dynamic> data) =>
      OrdersLandWorkRow(data);
}

class OrdersLandWorkRow extends SupabaseDataRow {
  OrdersLandWorkRow(Map<String, dynamic> data) : super(data);

  @override
  SupabaseTable get table => OrdersLandWorkTable();
  ...
  double? get palletCount => getField<double>('palletCount');
  set palletCount(double? value) => setField<double>('palletCount', value);
