  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case OrdersSeaArchieveRow:
            return OrdersSeaArchieveRow(data);
          case BatchNumberRow:
            return BatchNumberRow(data);
          ...
          case TestRow:
            return TestRow(data);
          case BatchNumberArchieveRow:
            return BatchNumberArchieveRow(data);
          case OrdersSeaRow:
            return OrdersSeaRow(data);
          case OrdersLandWorkRow:
            return OrdersLandWorkRow(data);
          default:
            return null;
        }
