...
class _RegPageWidgetState extends State<RegPageWidget> {
  ...
  void initState() {
    ...
    _model.textFieldPassConfirmController ??= TextEditingController();
    _model.textFieldPassConfirmFocusNode ??= FocusNode();
                                                        ...
                                                        iconPadding:
                                                            EdgeInsetsDirectional
                                                                .fromSTEB(
                                                                    ...
                                                                    0.0,
                                                                    0.0),
                                                        color: _model.textFieldNameController
                                                                        .text !=
                                                                    null &&
                                                                _model
                                                                        .textFieldNameController
                                                            ...
                                                            child: Padding(
                                                              ...
                                                              child: Text(
                                                                FFLocalizations.of(
                                                                        context)
                                                                    .getText(
                                                                  '4ptv8z0s' /* Введите почту для входа */,
                                                                ),
                                                                style: FlutterFlowTheme.of(
                                                                        context)
                                                                    .bodyMedium
                                                    ...
                                                    child: Padding(
                                                      ...
                                                      child: Text(
                                                        FFLocalizations.of(
                                                                context)
                                                            .getText(
                                                          'pfj1o3sg' /* Придумайте восьмизначный парол... */,
                                                        ),
                                                        style: FlutterFlowTheme
                                                                .of(context)
                                                            .bodyMedium
                                                      ...
                                                      iconPadding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(
                                                                  ...
                                                                  0.0,
                                                                  0.0),
                                                      color: _model.textFieldPassController
                                                                      .text !=
                                                                  null &&
                                                              _model
                                                                      .textFieldPassController
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  if (_model
                                                          ...
                                                          .text ==
                                                      _model
                                                          .textFieldPassConfirmController
                                                          .text)
                                                    Expanded(
                                                      child: Padding(
                                                        padding:
                                                        ...
                                                        child: Text(
                                                          FFLocalizations.of(
                                                                  context)
                                                              .getText(
                                                            'y5n66grn' /* Подтвердите ваш пароль */,
                                                          ),
                                                          style: FlutterFlowTheme
                                                                  .of(context)
                                                              .bodyMedium
                                                  ...
                                                  child: Container(
                                                    ...
                                                    child: TextFormField(
                                                      controller: _model
                                                          .textFieldPassConfirmController,
                                                      focusNode: _model
                                                          .textFieldPassConfirmFocusNode,
                                                      onChanged: (_) =>
                                                          EasyDebounce.debounce(
                                                        '_model.textFieldPassConfirmController',
                                                        Duration(
                                                            milliseconds: 1),
                                                        () => setState(() {}),
                                                      ),
                                                      obscureText: !_model
                                                          .textFieldPassConfirmVisibility,
                                                      decoration:
                                                          InputDecoration(
                                                        labelStyle:
                                                            FlutterFlowTheme.of(
                                                        ...
                                                        suffixIcon: InkWell(
                                                          ...
                                                          focusNode: FocusNode(
                                                              skipTraversal:
                                                                  true),
                                                          child: Icon(
                                                            _model.textFieldPassConfirmVisibility
                                                                ? Icons
                                                                    .visibility_outlined
                                                                : Icons
                                                                    .visibility_off_outlined,
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      'nc9zxm06' /* Мы отправим вам на почту код п... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'p31krxsj' /* Проверьте папку со спамом, есл... */,
                                                  ),
                                        ...
                                        Flexible(
                                          child: Padding(
                                            ...
                                            child: Text(
                                              FFLocalizations.of(context)
                                                  .getText(
                                                's5s2mmf4' /* Вставьте код, который пришел н... */,
                                              ),
                                              textAlign: TextAlign.center,
                                              style:
                                            ...
                                            children: [
                                              Expanded(
                                                child: Text(
                                                  FFLocalizations.of(context)
                                                      .getText(
                                                    'kge4kc32' /* Проверьте папку со спамом, есл... */,
                                                  ),
                                                  textAlign: TextAlign.center,
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                              ...
                                              Expanded(
                                                child: Padding(
                                                  ...
                                                  child: Text(
                                                    FFLocalizations.of(context)
                                                        .getText(
                                                      '3lci0xmu' /* Поздравляем! Регистрация завер... */,
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                                                        .bodyMedium
